    ...
    <div class="app">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <a class="nav-item is-active" href="<?= htmlspecialchars(url('/admin/audit'), ENT_QUOTES, 'UTF-8') ?>">Audyt</a>
            </nav>
        ...
        <main class="main">
            <header class="topbar">
                <div>
                    <div class="page-title">Audyt</div>
                    <div class="page-subtitle">Historia działań w systemie</div>
                </div>
                <a class="btn-primary" href="#">Filtry</a>
            </header>
